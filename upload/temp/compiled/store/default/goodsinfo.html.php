...
specs.push(new spec(<?php echo $this->_var['spec']['spec_id']; ?>, '<?php echo htmlspecialchars($this->_var['spec']['spec_1']); ?>', '<?php echo htmlspecialchars($this->_var['spec']['spec_2']); ?>', <?php echo $this->_var['spec']['price']; ?>, <?php echo $this->_var['spec']['stock']; ?>,
    '<?php echo $this->_var['spec']['member_price_show']; ?>'));
member_arr[i]="<?php echo $this->_var['spec']['member_price_show']; ?>"
i++;
...
?>
    ...
    <div class="ware_text">
        <div class="rate">
            ...
            <span >会员价格: </span><span class="fontColor3" ectype="goods_member_price" style="margin-left: 24px">
            <?php if ($this->_var['goods']['_specs']['0']['member_price_show'] == "false"): ?>
            - -
            <?php else: ?>
            <?php echo price_format($this->_var['goods']['_specs']['0']['member_price_show']); ?>
            <?php endif; ?></span><br />
