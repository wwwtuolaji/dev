                        ...
                        <div class="add_spec" ectype="dialog_contents" style="display: none">
                            ...
                            <div class="table" ectype="spec_editor">
                                <ul class="th" style="width: 850px">
                                    ...
                                    <li class="distance1">店主至尊</li>
                                    <li class="distance1">至尊价格</li>
                                    <li class="distance1">金卡价格</li>
                                    <li class="distance1">福禄价格</li>
                            ...
                            <div class="products">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="arrange"  ectype="no_spec"><input name="spec_id" value="<?php echo $this->_var['goods']['_specs']['0']['spec_id']; ?>" type="hidden" /><input  id="price"name="price" value="<?php echo $this->_var['goods']['_specs']['0']['price']; ?>" type="text" class="text width_short" /></div>
                                    </li> 
                                    <li>
                                        <h2  ectype="no_spec">店主至尊: </h2>
                                        <div class="arrange"  ectype="no_spec"><input name="spec_id" value="<?php echo $this->_var['goods']['_specs']['0']['spec_id']; ?>" type="hidden" /><input name="member_price_1" value="<?php echo $this->_var['goods']['_specs']['0']['member_price_1']; ?>" type="text" class="text width_short"id="member_price_1" />
                                    ...
                                    <li>
                                        <h2  ectype="no_spec">至尊价格: </h2>
                                        <div class="arrange"  ectype="no_spec"><input name="spec_id" value="<?php echo $this->_var['goods']['_specs']['0']['spec_id']; ?>" type="hidden" /><input name="member_price_2" value="<?php echo $this->_var['goods']['_specs']['0']['member_price_2']; ?>" type="text" class="text width_short" id="member_price_2"/> &nbsp;折扣比率：<input style="width: 40px" type="text"class="text width_short" onblur="change_price(this,'member_price_2')"onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onafterpaste="this.value=this.value.replace(/[^0-9]/g,'')"maxlength="2">%</div>
                                    </li>
                                    <li>
                                        <h2  ectype="no_spec">金卡价格: </h2>
                                        <div class="arrange"  ectype="no_spec"><input name="spec_id" value="<?php echo $this->_var['goods']['_specs']['0']['spec_id']; ?>" type="hidden" /><input name="member_price_3" value="<?php echo $this->_var['goods']['_specs']['0']['member_price_3']; ?>" type="text" class="text width_short" id="member_price_3"/> &nbsp;折扣比率：<input style="width: 40px" type="text"class="text width_short" onblur="change_price(this,'member_price_3')"onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onafterpaste="this.value=this.value.replace(/[^0-9]/g,'')"maxlength="2">%</div>
                                    </li>
                                    <li>
                                        <h2  ectype="no_spec">福禄价格: </h2>
                                        <div class="arrange"  ectype="no_spec"><input name="spec_id" value="<?php echo $this->_var['goods']['_specs']['0']['spec_id']; ?>" type="hidden" /><input name="member_price_4" value="<?php echo $this->_var['goods']['_specs']['0']['member_price_4']; ?>" type="text" class="text width_short" id="member_price_4"/> &nbsp;折扣比率：<input style="width: 40px" type="text"class="text width_short" onblur="change_price(this,'member_price_4')"onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onafterpaste="this.value=this.value.replace(/[^0-9]/g,'')"maxlength="2">%</div>
                                    </li>
                                        ...
                                        <div class="box_arr" ectype="has_spec"  style="display: none; width: 450px">
                                            <table ectype="spec_result" border="1" >
                                                <tr>
                                                    ...
                                                    <th col="stock">库存</th>
                                                    <th col="sku">货号</th>
                                                    <th col="member_price_1">店主至尊</th>
                                                    <th col="member_price_2">至尊价格</th>
                                                    <th col="member_price_3">金卡价格</th>
                                                    <th col="member_price_4">福禄价格</th>
                                                </tr>
