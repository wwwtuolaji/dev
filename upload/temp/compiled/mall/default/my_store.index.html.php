...
function setImagePreview2(avalue) {
    ...
    if(docObj.files &&docObj.files[0])
    {
        //火狐下，直接设img属性
        imgObjPreview.style.display = 'block';
        imgObjPreview.style.width = '607px';
        imgObjPreview.style.height = '120px';
        //imgObjPreview.src = docObj.files[0].getAsDataURL();
            ...
            <form method="post" enctype="multipart/form-data" id="my_store_form">
                    <div class="setup">
                        <div class="photo relative1">
                            ...
                            <p><img id="preview"src="<?php if ($this->_var['store']['store_logo'] != ''): ?><?php echo $this->_var['store']['store_logo']; ?><?php else: ?>data/system/default_store_logo.gif<?php endif; ?>" width="120" height="120" ectype="store_logo" /></p>
                            <b class="ie6hack">
                                <div class="txt" >更换店标</div>
                                <input  class="txt"  name="store_logo" type="file" id="doc" onchange="javascript:setImagePreview();"  ectype="change_store_logo"/>
                            </b>
                            <span class="explain">此处为您的店铺标志，将显示在店铺信息栏里建议尺寸100*100像素</span>
                        </div>
                        <div class="photo relative2">
                            <p><img id="preview2"src="<?php if ($this->_var['store']['store_banner'] != ''): ?><?php echo $this->_var['store']['store_banner']; ?><?php else: ?><?php echo $this->res_base . "/" . 'images/member/banner.gif'; ?><?php endif; ?>" width="607" height="120" ectype="store_banner" /></p>
                            <b>
                                <div class="txt" >更换店铺条幅</div>
                                <input  class="txt" name="store_banner"  type="file" id="doc2" onchange="javascript:setImagePreview2();"  ectype="change_store_logo"/>
                            </b>
