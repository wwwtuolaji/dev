...
<div class="info">
  <form method="post" enctype="multipart/form-data" id="user_form">
    <table class="infoTable">
      ...
      <input type="hidden" name="uname" id="uname"value="<?php echo htmlspecialchars($this->_var['user']['user_name']); ?>" />
        <tr>
        <th class="paddingT15"> 外部卡号</th>
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput2" name="member_card_num" type="text" id="member_card_num"value="<?php echo htmlspecialchars($this->_var['user']['member_card_num']); ?>" />
      ...
      <tr>
        ...
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput2" name="inner_card_num" type="text" id="inner_card_num"value="<?php echo htmlspecialchars($this->_var['user']['inner_card_num']); ?>" />
        ...
        <select class="infoTableInput2"  id="member_level" name="member_level">
          <option value="1" <?php if ($this->_var['user']['member_level'] == 1): ?>selected<?php endif; ?>>店主至尊卡</option>
          <option value="2" <?php if ($this->_var['user']['member_level'] == 2): ?>selected<?php endif; ?>>至尊卡</option>
          <option value="3" <?php if ($this->_var['user']['member_level'] == 3): ?>selected<?php endif; ?>>金卡</option>
          <option value="4" <?php if ($this->_var['user']['member_level'] == 4): ?>selected<?php endif; ?>>福禄卡</option>
          <option value="5" <?php if ($this->_var['user']['member_level'] == 5): ?>selected<?php endif; ?>>未知会员</option>
        </select>
          <?php if ($this->_var['user']['user_id']): ?>        
          <?php endif; ?>        </td>
      </tr>
